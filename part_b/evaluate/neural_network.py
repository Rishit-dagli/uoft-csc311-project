...
def evaluate(model, train_data, valid_data):
    ...
    for i, u in enumerate(valid_data["user_id"]):
        ...
        predicted_values.append(int(guess))
...
def main():
    ...
    test_accuracy, preds = evaluate(model, zero_train_matrix, test_data)
    np.savez('nnc.npz', preds=preds)
